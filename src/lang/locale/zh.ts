...
export default {
    ...
    "parseError": "解析错误",
    "metaUpdated": "元数据已更新",
    "noProviderSelected": "未选择 LLM 提供商",
    ...
    "modelName": "模型名称",
    "apiProvider": "API 提供商",
    "apiProviderDesc": "配置你的 AI 提供商设置。自定义提供商需要额外配置。",
    "llmConfiguration": "API 配置",
    "selectApiProvider": "选择 API 提供商",
    "endpoint": "接口路径",
    "enterEndpoint": "输入你的 API 接口路径",
    "addProvider": "添加提供商",
    "editProvider": "编辑",
    "deleteProvider": "删除",
    "providerName": "提供商名称",
    ...
    "providerType": "提供商类型",
    "selectProviderType": "选择 LLM 提供商类型",
    "modelSelection": "模型选择",
    "selectModel": "选择该提供商的模型",
    "currentModel": "当前模型",
    "modelOptions": "模型选项",
    "selectModelFromProvider": "从当前提供商中选择一个模型",
    "currentlySelected": "当前已选择",
    "model": "模型",
    "selectTheModelToUse": "选择要使用的模型",
    "enterYourApiKey": "输入你的 API 密钥",
    "show": "显示",
    "hide": "隐藏",
    "apiConfig": "API 配置",
    "customProviderConfig": "自定义提供商配置",
    "baseUrlDesc": "输入自定义 API 的基础 URL",
    "endpointDesc": "输入 API 的接口路径",
